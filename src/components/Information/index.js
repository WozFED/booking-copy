    ...
    <div className="information">
      <div className="information__booking">
        ...
        <div>
          ...
          <p>
            Otrzymaj natychmiastowe potwierdzenie i możliwość BEZPŁATNEGO
            odwołania rezerwacji większości pokoi!
          </p>
        </div>
      </div>
      <div className="information__covid">
        ...
        <div>
          <p>
            Od 6 kwietnia 2020 roku zasady odwołania dokonanych rezerwacji będą
            obowiązywać bez względu na koronawirusa. Zalecamy rezerwację opcji z
            bezpłatnym odwołaniem w razie, gdyby Twoje plany musiały ulec
            zmianie. Dowiedz się więcej
          </p>
        </div>
      </div>
