        ...
        <div className = "inputs">
           ...
           <div className = "inputs__inputs">
            ...
            <Icon icon="bi:calendar-week-fill" style = {{marginRight: '5px'}}/>
                <input disabled = {true} placeholder = "Zameldowanie - Wymeldowanie"></input>
            </div>
            <div className = "inputs__element test2">
                <Icon icon="mdi:human-greeting-variant" style = {{marginRight: '5px'}}/>
                <input disabled = {true} type = 'text' placeholder = "2 dorosłych &#8226; 0 dzieci &#8226; 1 pokój"></input>
            </div>
            <div className = "inputs__element test">
            
                <div className = "inputs__button"><p>Szukaj</p></div>
            </div>
