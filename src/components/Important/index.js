...
const Important = () => {
  return (
    <div id="important" className="important">
        <div className = "important__header"><h2>Ważne informacje</h2>
      <button className="button-avaiable"><AnchorLink to = "#avaiable" ><p>Zobacz dostępność</p></AnchorLink></button></div>
      <div className="rules__section">
        ...
        <p>
          Ze względu na koronawirusa (COVID-19) upewnij się, że rezerwujesz ten
          obiekt zgodnie z wytycznymi władz lokalnych w miejscu docelowym, w tym
          między innymi dotyczącymi celu podróży i maksymalnego dozwolonego
          rozmiaru grupy.
        </p>
        ...
        <p>
          Z powodu koronawirusa (COVID-19) noszenie maseczki jest obowiązkowe we
          wszystkich pomieszczeniach ogólnodostępnych.
        </p>
